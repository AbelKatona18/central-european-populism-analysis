# Methodological Codebook: Central European Populism Shift

## Project Objective
This data pipeline tracks the quantitative linguistic transition of Hungarian populist rhetoric from a status-quo Thesis (Ideological/Cosmic Sovereignty) to an insurgent Synthesis (Empirical/Procedural Accountability).

## 1. Textual Coding Variables
...
## 2. Behavioral Sub-Sample Survey Variables
* Sample Size (N): 60 Teen Participants (Debrecen/Eastern Hungary Cluster)
* Metrics Tracked: 1-5 Likert scale values monitoring localized institutional trust in central state apparatuses vs. European Union structural frameworks.
